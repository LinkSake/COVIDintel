...
<div class="row justify-content-center">
    <div class="col-md-11">
        <div class="card">
            <div class="card-header">Eliminar mi relación con la organización</div>
            <div class="card-body">
                <div class="alert alert-danger" role="alert">
                    Una vez eliminada una relación, no podrás recuperarla
                </div>
                <ul class="list-group">
                    ...
                    <div style="float: right; margin-top: 1rem !important;">
                        <form action="{{action('UserOrgController@delete')}}" method="post">
                            @csrf
